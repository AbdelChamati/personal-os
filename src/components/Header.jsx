...
export default function Header() {
  ...
  const dateStr = today.toLocaleDateString(dateLocale, { month: 'long', day: 'numeric' });
          ...
          {isEditing && (
            <div className="name-edit">
              <input
                ...
                autoFocus
              />
              <button className="name-btn name-save" onClick={handleSaveName}>{t('header.save')}</button>
              <button className="name-btn name-cancel" onClick={handleCancel}>{t('header.cancel')}</button>
            </div>
          )}
        </div>
        <div className="header-date-actions">
          <div className="language-switcher">
            <label htmlFor="language-select" className="language-label">{t('header.languageShort')}:</label>
            <select
              id="language-select"
          ...
          <button className="theme-toggle" onClick={toggleTheme} aria-label={t('header.toggleTheme')}>
